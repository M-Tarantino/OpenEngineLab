...
(function (root) {
  ...
  const DE = {
    ...
    running: "LÄUFT", stopped: "GESTOPPT", engineOff: "MOTOR AUS", weakestLink: "Weakest Link",
    ...
    ignitionBtn: "START/STOPP", estop: "NOT-STOPP", tabSchematic: "Schema", tabKennfield: "Kennfeld",
    ...
    schematicAlt: "Motorschema", cylinderLabel: "Zylinder", frontViewAlt: "Motor-Frontansicht", topViewAlt: "Motor-Draufsicht", bankLabel: "Bank",
    viewSide: "Seite", viewFront: "Front", viewTop: "Oben",
    ...
    dynoTestExplain: "Ein Dyno-Test („Dynamometer“) simuliert den Motor unter Volllast von Leerlauf bis zur Drehzahlbegrenzung und misst dabei Leistung und Drehmoment über die gesamte Drehzahlbandbreite — genau wie ein echter Rollenprüfstand. Die Kurve zeigt, wo der Motor sein Leistungs- und Drehmomentmaximum erreicht.",
  ...
  const EN = {
    ...
    running: "RUNNING", stopped: "STOPPED", engineOff: "ENGINE OFF", weakestLink: "Weakest Link",
    ...
    ignitionBtn: "START/STOP", estop: "E-STOP", tabSchematic: "Schematic", tabKennfield: "Map",
    ...
    schematicAlt: "Engine schematic", cylinderLabel: "Cylinder", frontViewAlt: "Engine front view", topViewAlt: "Engine top view", bankLabel: "Bank",
    viewSide: "Side", viewFront: "Front", viewTop: "Top",
    ...
    dynoTestExplain: "A dyno test (dynamometer test) simulates the engine at wide-open throttle from idle to the rev limiter, measuring power and torque across the full RPM range — just like a real rolling-road dyno. The curve shows exactly where the engine makes peak power and peak torque.",
  ...
  const FR = {
    ...
    running: "EN MARCHE", stopped: "ARRÊTÉ", engineOff: "MOTEUR ARRÊTÉ", weakestLink: "Maillon Faible",
    ...
    ignitionBtn: "DÉMARRER/ARRÊTER", estop: "ARRÊT D'URGENCE", tabSchematic: "Schéma", tabKennfield: "Cartographie",
    ...
    schematicAlt: "Schéma du moteur", cylinderLabel: "Cylindre", frontViewAlt: "Vue avant du moteur", topViewAlt: "Vue de dessus du moteur", bankLabel: "Rangée",
    viewSide: "Côté", viewFront: "Avant", viewTop: "Dessus",
    ...
    dynoTestExplain: "Un test dyno (banc dynamométrique) simule le moteur à pleins gaz du ralenti jusqu'au limiteur de régime, en mesurant la puissance et le couple sur toute la plage de régime — comme un vrai banc à rouleaux. La courbe montre précisément où le moteur atteint son pic de puissance et de couple.",
  ...
  const ES = {
    ...
    running: "EN MARCHA", stopped: "DETENIDO", engineOff: "MOTOR APAGADO", weakestLink: "Punto Débil",
    ...
    ignitionBtn: "ARRANCAR/PARAR", estop: "PARO DE EMERGENCIA", tabSchematic: "Esquema", tabKennfield: "Mapa",
    ...
    schematicAlt: "Esquema del motor", cylinderLabel: "Cilindro", frontViewAlt: "Vista frontal del motor", topViewAlt: "Vista superior del motor", bankLabel: "Bancada",
    viewSide: "Lateral", viewFront: "Frontal", viewTop: "Superior",
    ...
    dynoTestExplain: "Una prueba de dinamómetro simula el motor a fondo desde ralentí hasta el limitador de revoluciones, midiendo potencia y par en todo el rango de RPM — igual que un banco de rodillos real. La curva muestra exactamente dónde el motor alcanza su pico de potencia y de par.",
